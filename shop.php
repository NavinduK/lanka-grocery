                    ...
                    <div style="margin-left: 3px;" class="product-item">
                        ...
                        <div class="product-desc">
                            ...
                            <div class="product-btn-container">
                                <a href="./product.php?product=<?php echo ($row['pid']); ?>" target="_blank" class="product-btn"><i class="fas fa-eye"></i> View</a>
                            </div>
                            <div class="add-container">
                                <a class="product-btn cart-btn" href="./product.php?product=<?php echo ($row['pid']); ?>"><i class="fas fa-cart-plus"></i> Add to Cart</a>
                            </div>
                        </div>
                    </div>
                <?php } ?>
