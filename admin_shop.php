                ...
                <div style="margin-left: 3px;" class="product-item">
                    ...
                    <div class="product-desc">
                        ...
                        <div class="product-btn-container">
                            <a href="./admin_product.php?product=<?php echo ($row['pid']); ?>" target="_blank"
                                class="product-btn"><i class="fas fa-eye"></i> View & Edit</a>
                        </div>
                        <div class="add-container">
                            <a class="product-btn cart-btn" href="./admin_shop.php?delete=<?php echo ($row['pid']); ?>"><i
